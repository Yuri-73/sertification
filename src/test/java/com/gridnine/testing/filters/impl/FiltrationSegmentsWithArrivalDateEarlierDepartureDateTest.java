...
class FiltrationSegmentsWithArrivalDateEarlierDepartureDateTest {
    ...
    private FiltrationSegmentsWithArrivalDateEarlierDepartureDate out = new FiltrationSegmentsWithArrivalDateEarlierDepartureDate();
    ...
    void filter() {
        ...
        //check:
        assertEquals(out.filter(flights), flights2);
    }
}