...
class FiltrationDepartureBeforeCurrentTimeTest {
    ...
    void filter() {
        ...
        Flight flight2 = new Flight(segments2); //для фильтра-1: рейс времени вылета ранее текущей даты
        ...
        //check:
        assertEquals(filtrationDepartureBeforeCurrentTime.filter(flights), flights1);
    }
}
